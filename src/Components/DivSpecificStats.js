            ...
            <div className="visualiser-conatiner">
                <div className="canvas-container">
                    <div className="top-label">
                        <div className="label-item selected">Contest Analysis - Div 2 Statistics</div>
                    </div>
                    <div className="stats-container">
                        ...
                        <StatContainer>
                            <div className="item-left">Avg Solved per Contest : </div>
                            <div className="item-right">1</div>
                        </StatContainer>
                        <StatContainer>
                        ...
                        <StatContainer>
                            <div className="item-left">Average Rank : </div>
                            <div className="item-right">1</div>
                        </StatContainer>
                    </div>
                </div>
